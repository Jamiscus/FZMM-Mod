...
public class EncryptBookScreen extends BaseFzmmScreen implements IMementoScreen {
    ...
    private TextBoxComponent messageField;
    ...
    protected void setupButtonsCallbacks(FlowLayout rootComponent) {
        ...
        this.titleField = TextBoxRow.setup(rootComponent, TITLE_ID, config.defaultBookTitle(), WrittenBookItem.MAX_TITLE_VIEW_LENGTH);
    ...
    public void restoreMemento(IMementoObject mementoObject) {
        ...
        this.seedField.text(String.valueOf(memento.seed));
        this.messageField.text(memento.message);
